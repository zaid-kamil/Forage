...
import com.example.forage.ui.viewmodel.ForageInventoryViewModelFactory
...
class ForageableListFragment : Fragment() {
    private val viewModel: ForageableViewModel by activityViewModels {
        ForageInventoryViewModelFactory((requireActivity().application as BaseApplication).database.forageableDao())
    }
